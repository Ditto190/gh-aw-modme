...
import { requireErrorCodeInGithubThrowRule } from "./rules/require-error-code-in-github-throw";
...
const plugin = {
  ...
  rules: {
    ...
    "require-error-code-in-github-throw": requireErrorCodeInGithubThrowRule,
  },
};
